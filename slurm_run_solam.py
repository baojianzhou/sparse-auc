...
def test_single_solam(task_id, results_path):
...
def test_single_stoht_am(task_id, results_path):
    results = load_results()
    g_pass = 1
    g_iters = 5
    g_cv = 5
...
def main():
    ...
    test_single_solam(task_id=os.environ['SLURM_ARRAY_TASK_ID'], results_path=results_path)
