...
bool __sht_am_sparse(const double *x_values,// the values of these nonzeros.
...
bool algo_sht_am(sht_am_para *para, sht_am_results *results) {
    if (para->is_sparse) {
        // sparse case (for sparse data).
        return __sht_am_sparse(para->sparse_x_values,
                               para->sparse_x_indices,
                               para->sparse_x_positions,
                               para->sparse_x_len_list,
                               para->y_tr,
...
bool algo_graph_am(graph_am_para *para, graph_am_results *results) {
    if (para->is_sparse) {
        // sparse case (for sparse data).
        return __graph_am_sparse(para->sparse_x_values,
                                 para->sparse_x_indices,
                                 para->sparse_x_positions,
                                 para->sparse_x_len_list,
                                 para->y_tr,
