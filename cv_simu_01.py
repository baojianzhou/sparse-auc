...
def run_spam_l1(trial_id, fold_id, para_c, para_l1, num_passes, data):
    ...
    return {'algo_para': [trial_id, fold_id, para_c, para_l1],
            'auc_wt': roc_auc_score(y_true=data['y_tr'][te_index], y_score=np.dot(data['x_tr'][te_index], wt)),
            'auc_wt_bar': roc_auc_score(y_true=data['y_tr'][te_index], y_score=np.dot(data['x_tr'][te_index], wt_bar)),
            'auc': auc,
            'rts': rts,
            'wt': wt,
